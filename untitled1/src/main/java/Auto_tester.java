...
public class Auto_tester {
    ...
    public void full_test_texts() throws IOException {
        System.out.println("entrei aqui");
        Test t=new Test();
        System.out.println("iniciei test");
        PrintWriter pw = new PrintWriter(new File("test_results_full.csv"));
        PrintWriter pw2 = new PrintWriter(new File("test_results_neural_net_full.csv"));
        StringBuilder sb = new StringBuilder();
        StringBuilder sb2 = new StringBuilder();
        //FILE FOR EVERYONE
        sb.append("total_words");
        ...
        for(String s:a1){
            t.run_test(s);
            sb2.append("0;");
            sb2.append(t.print_full_test()+"\n");
            sb.append(t.print_full_test());
            sb.append(";1\n");
        }
        for(String s:a2){
            //System.out.println("New test");
    ...
    public void full_train_texts() throws IOException {
        //System.out.println("entrei aqui");
        Test t=new Test();
        //System.out.println("iniciei test");
        PrintWriter pw = new PrintWriter(new File("train_results_full.csv"));
        PrintWriter pw2 = new PrintWriter(new File("train_results_neural_net_full.csv"));
        StringBuilder sb = new StringBuilder();
        StringBuilder sb2 = new StringBuilder();
        //FILE FOR EVERYONE
        sb.append("total_words");
