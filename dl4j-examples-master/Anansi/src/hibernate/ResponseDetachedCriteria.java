...
public class ResponseDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public final IntegerExpression contextId;
	public final AssociationExpression context;
	...
	public ResponseDetachedCriteria() {
		...
		contextId = new IntegerExpression("context.ID", this.getDetachedCriteria());
		context = new AssociationExpression("context", this.getDetachedCriteria());
	...
	public ContextDetachedCriteria createContextCriteria() {
		return new ContextDetachedCriteria(createCriteria("context"));
	}
