...
public class RetrieveAndUpdatePEIMVPData {
	public void retrieveAndUpdateTestData() throws PersistentException {
		...
		try {
			...
			Context context = ContextDAO.loadContextByQuery(null, null);
			// Update the properties of the persistent object
	...
	public void retrieveByCriteria() throws PersistentException {
		...
		System.out.println("Retrieving Context by ContextCriteria");
		ContextCriteria contextCriteria = new ContextCriteria();
		// Please uncomment the follow line and fill in parameter(s)
		//contextCriteria.ID.eq();
		System.out.println(contextCriteria.uniqueContext());
