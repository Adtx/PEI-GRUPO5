...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="/Anansi/">For Personal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="companies#login1">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="companies#registar1">Register</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <form name="sentMessage" id="contactForm1"  accept-charset="ISO-8859-1" action="companiesLogin" method="post">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <form name="sentMessage" id="contactForm2"  accept-charset="ISO-8859-1" method="post" action="/Anansi/companies">
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>Company name</label>
                            <input class="form-control" id="name" type="text" name="nome" placeholder="Company name" required data-validation-required-message="Please insert your full name.">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div class="control-group">
