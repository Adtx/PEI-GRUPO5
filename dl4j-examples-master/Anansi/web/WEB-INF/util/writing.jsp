  ...
  <!-- Contact Section -->
    <section id="test" style="background-color:#18bc9c; margin-top:25px;">
      <div class="container" >
        ...
        <form  action="/Anansi/corrector" method="post">
          ...
          <div class="form-inline row" style="border: 2px solid #212529; border-radius:10px; padding:10px;">
              <div class="form-group col-sm-6" style="text-align:center; padding-left: 8%;">
                <input type="text" class="form-control" id="name" name="name" style="width: 80%" placeholder="Enter context code" >
              </div>
              <div class="form-group col-sm-6" style="text-align:center; padding-left: 12%;">
                <input type="text" class="form-control" id="pwd" name="pass" style="width: 80%" placeholder="Enter context password" >
              </div>
          ...
          <div class="row">
            ...
            <textarea onkeyup="verify(this)" class="form-control" type="text" name="texto" rows="10" id="text"></textarea>
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p id="result" style="color:#c82333;">${sessionScope.info}</p>
            </div>
          </div>
        </form>
    ...
    <script>
        function verify(textarea){
            ...
            else number_of_words = text.match(/[a-zA-Z0-9]+/g).length;

            var disabled, color, text;

            if (number_of_words<30){
                disabled = true;
                text = '<i class="fa fa-exclamation-triangle" style="color:#c82333;"></i> &nbsp;';
                color="#c82333";
            }
            else {
                disabled = false;
                text = '<i class="fa fa-tachometer" style="color:green"></i> &nbsp;';
                color="white";
            }

            submit.disabled = disabled;
            words.innerHTML = text + number_of_words + ' words';
