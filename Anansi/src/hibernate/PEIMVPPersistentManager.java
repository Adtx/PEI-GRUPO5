...
public class PEIMVPPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PEIMVP";
	...
	private PEIMVPPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PEIMVPPersistentManager();
		}
