...
public class Language_moddeling {
    ...
    private void load_bigram_model() {
        ...
        try {
            script = loader.loadScript("/Users/andrepinto/GitHub/PEI-GRUPO5/Anansi/load_bigram_model.ls");
    ...
    public float bigram_model_value(String text) {
        ...
        float res=0;
        try {
            script = loader.loadScript("/Users/andrepinto/GitHub/PEI-GRUPO5/Anansi/bigram_model_script.ls");
    ...
    public float bigram_model_value_reverse(String text) {
        ...
        float res=0;
        try {
            script = loader.loadScript("/Users/andrepinto/GitHub/PEI-GRUPO5/Anansi/bigram_model_script_reverse.ls");
        }catch (YourCodeSucksException syntaxErrors){
            System.out.println(syntaxErrors.formatErrors());
